...
MAPS = [
    "Route6_hns", "Gate_SaffronCity_Route6_hns", "SaffronCity_hns",
    "Gate_SaffronCity_Route5_hns", "Route5_hns", "BlackthornCity_hns",
    "IndigoPlateau_hns", "IndigoPlateau_PokemonCenter_hns",
]
WARP_RULES = {m: [] for m in MAPS}
MUSIC = {
    "Route6_hns": "MUS_RG_ROUTE3",
    "Gate_SaffronCity_Route6_hns": "MUS_RG_CELADON",
    "SaffronCity_hns": "MUS_RG_SILPH",
    "Gate_SaffronCity_Route5_hns": "MUS_RG_CELADON",
    "Route5_hns": "MUS_RG_ROUTE3",
    "BlackthornCity_hns": "MUS_RG_ROUTE11",
    "IndigoPlateau_hns": "MUS_RG_VICTORY_ROAD",
    "IndigoPlateau_PokemonCenter_hns": "MUS_RG_HALL_OF_FAME",
}
GROUP = {
    "Gate_SaffronCity_Route6_hns": "gMapGroup_PlasticOxInteriors",
    "Gate_SaffronCity_Route5_hns": "gMapGroup_PlasticOxInteriors",
    "IndigoPlateau_PokemonCenter_hns": "gMapGroup_PlasticOxInteriors",
}
...
WARP_RULES.update({
    "SaffronCity_hns": [{"x":44,"y":21,"dest_map":"MAP_MART_KANTO_HNS","dest_warp_id":"0"}],
    "BlackthornCity_hns": [
        {"x":27,"y":48,"dest_map":"MAP_POKEMON_CENTER_JOHTO_HNS","dest_warp_id":"0"},
        {"x":16,"y":48,"dest_map":"MAP_MART_JOHTO_HNS","dest_warp_id":"0"}],
    "IndigoPlateau_hns": [{"x":11,"y":6,"dest_map":"MAP_INDIGO_PLATEAU_POKEMON_CENTER_HNS","dest_warp_id":"0"}],
    "IndigoPlateau_PokemonCenter_hns": [{"x":19,"y":16,"dest_map":"MAP_DYNAMIC","dest_warp_id":"WARP_ID_DYNAMIC"}],
})
