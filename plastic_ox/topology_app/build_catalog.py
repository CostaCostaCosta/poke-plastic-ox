...
ROUTE_TRANSITION_PORTS = {
    ...
    "R7": [("SAFFRON", "Saffron Gate", "gate"), ("UNDERGROUND", "Underground", "cave")],
    "R8": [("SAFFRON", "Saffron Gate", "gate"), ("UNDERGROUND", "Underground", "cave")],
    "R20": [("SEAFOAM_1", "Seafoam Islands Entrance 1", "cave"), ("SEAFOAM_2", "Seafoam Islands Entrance 2", "cave")],
    "R24": [("CERULEAN_CAVE", "Cerulean Cave", "cave")],
...
TOWNS = [
    ...
    dict(id="BLACK", name="Blackthorn City", region="Johto", kind="town", ports={"S":"land"}, port_labels={"S":"Route 45"}, special_ports=[{"id":"ICE_PATH","label":"Ice Path","type":"cave","regional":True}, {"id":"DRAGONS_DEN","label":"Dragon's Den","type":"cave","regional":True}], asset="BLACK.png", required=True, story_order=17, notes="North opens to Dragon's Den; Ice Path has a separate cave link; south descends to Route 45."),
...
DUNGEON_LIBRARY = [
    ...
    ("UNDERGROUND","Underground Path","Kanto","cave",2),
