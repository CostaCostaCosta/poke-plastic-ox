...
This document defines the canonical overworld structure for **Pokémon Plastic Ox**. It supersedes `plastic_ox_map_v0.2.md` and incorporates the physical-port layout pass and junction inventory.
...
| 11 | **Saffron City** | Kanto | **Gym 8 — Sabrina** | Silph Co. climax; final Gym |
...
**Route 19 → Route 20 → Seafoam Islands → Route 20 → Cinnabar**
...
Seafoam remains a contained dungeon, not another regional cave connector.
...
No second villain sequence occurs after the Gym.
