...
#define I_LAX_INCENSE_BOOST             GEN_3  // In Gen4+, Lax Incense increases evasion by 10% instead of 5%.
...
#define I_EXP_SHARE_FLAG        FLAG_POX_EXP_ALL // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
