...
#define OW_TIME_OF_DAY_ENCOUNTERS       TRUE         // Plastic Ox uses morning/day/night encounter tables.
...
#define OW_UNION_DISABLE_CHECK           (!POX_LINK_ENABLED) // No background Union Room scanning in single-player builds.
