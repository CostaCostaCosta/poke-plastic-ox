...
// Learnsets
#define P_LVL_UP_LEARNSETS          GEN_3       // Plastic Ox uses RSE learnsets for Gen 1-3 species; later species use their first available learnsets.
...
#define P_EVOLUTION_TIER_GATING      TRUE        // Plastic Ox: if TRUE, evolutions are blocked until the player's badge count unlocks the target species' competitive tier (see plastic_ox/plasticox_encounters_v1.md).
