...
// Plastic Ox: HnS (Johto/Kanto) object graphics
...
// Plastic Ox: HnS object palettes
#define OBJ_EVENT_PAL_TAG_POX_KIMONO              0x1134
#define OBJ_EVENT_PAL_TAG_POX_SILVER              0x1135
