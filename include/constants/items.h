...
enum __attribute__((packed)) Item
{
    ...
    ITEM_MOVE_COMPENDIUM = 874,
    ITEM_CANDY_BAG = 875,
    ITEM_CUT_KEY = 876,
    ITEM_STRENGTH_KEY = 877,
    ITEM_SURF_KEY = 878,
    ITEM_HEADBUTT_KEY = 879,
    ITEM_TRAINING_KIT = 880,
    ITEM_POCKET_WATCH = 881,
    ITEM_SQUIRT_BOTTLE = 882,
    ITEM_WARP_BLOCK = 883,
    ITEM_ROCK_SMASH_KEY = 884,
